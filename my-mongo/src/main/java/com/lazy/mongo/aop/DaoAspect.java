package com.lazy.mongo.aop;

import cn.hutool.core.util.ObjectUtil;
import fire.control.common.mongo.annotation.DefaultValue;
import fire.control.common.mongo.annotation.IncrId;
import fire.control.common.mongo.service.IncrIdSrv;
...
public class DaoAspect {
  ...
  @Pointcut("execution(public * fire.control.common.mongo.service.BaseMongoSrv.*save*(..))")
  public void doSave() {
